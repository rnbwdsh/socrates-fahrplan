			...
			<form onsubmit={handleSubmit} class="space-y-6">
				<div>
					...
					<input
						...
						class="block w-full text-sm text-gray-500 dark:text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 dark:file:bg-gray-700 dark:file:text-blue-400 dark:hover:file:bg-gray-600"
					/>
				</div>
				...
				<div class="flex items-center">
					...
					/>
					<label for="emailVisibility" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">
